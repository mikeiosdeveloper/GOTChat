...
class LoginController: UIViewController, UITextFieldDelegate {
    ...
    var inputContailerViewHeightAnchor: NSLayoutConstraint?
    ...
    @objc func handleLoginRegisterChange() {
        ...
        inputContailerViewHeightAnchor?.constant = segmentedControl.selectedSegmentIndex == 0 ? 100 : 150
    ...
    func setupInputsContainerView() {
        ...
        inputContailerViewHeightAnchor = inputsContainerView.heightAnchor.constraint(equalToConstant: 150)
        inputContailerViewHeightAnchor!.isActive = true
